...
```
cd existing_repo
git remote add origin https://git.magenta.dk/rammearkitektur/os2mo-triggers/OS2mo-amqp-trigger-elevate-manager.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.magenta.dk/rammearkitektur/os2mo-triggers/OS2mo-amqp-trigger-elevate-manager/-/settings/integrations)
