...
async def terminate_existing_managers(
    ...
    previous_managers = one(existing_managers["org_units"]["objects"])["current"][
        "managers"
    ]
    ...
    for uuid in previous_managers_uuids:
        ...
        await gql_client.terminate_manager(**terminate_variables)
...
async def move_engagement(
    ...
    await gql_client.move_engagement(**update_engagement_variables)
